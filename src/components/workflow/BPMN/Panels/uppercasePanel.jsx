...
function UppercasePanel({
  upperCaseOperationData,
  setUpperCaseOperationData,
  addExpression,
  elementId,
  modeler,
  element,
  ...
  const handleInputChange = (event) => {
    ...
    setUpperCaseOperationData((prevData) => ({
      ...prevData,
      [name]: value
    }));
  };

  const submitUppercaseOperation = () => {
    set(`uppercase_${elementId}`, JSON.stringify(upperCaseOperationData));

    let local = get(`uppercase_${elementId}`) || null;
          ...
          <div className="flex flex-col justify-start">
            ...
            <span className="position-relative">
              <input
                ...
                type="text"
                name="input"
                value={upperCaseOperationData.input}
